...
VOID init_itypes_default_groups(){
	...
	group_identifiers[13][0].str = checked_strdup("MULSD");		// Scalar Double Precision
	...
	group_identifiers[13][24].str = checked_strdup("PSUBB");	//	Packed Integers
	...
	group_identifiers[13][26].str = checked_strdup("PMULUDQ");	// unsigned doubleword
	group_identifiers[13][27].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[13][27].str = checked_strdup("PCMPEQB");	// packed bytes
	...
	group_identifiers[13][31].str = checked_strdup("PCMPISTRI");	// string byte or word data
	group_identifiers[13][32].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[13][32].str = checked_strdup("PCMPGTD");		// greater than Dword
	...
	group_identifiers[13][35].str = checked_strdup("VPMAXSW");		// signed word
	...
	group_identifiers[13][50].str = checked_strdup("PCMPISTRM");	// Packed Compare Implicit Length Strings, Return Mask byte
	group_identifiers[13][51].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[13][51].str = checked_strdup("PMADDUBSW");	// Multiply and Add Packed Signed and Unsigned Bytes
	...
	group_identifiers[14][5].str = checked_strdup("PSHUFD");	// Packed Doublewords
	group_identifiers[14][6].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[14][6].str = checked_strdup("SHUFPS");	// fp
	group_identifiers[14][7].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[14][7].str = checked_strdup("VSHUFPS");	// fp
	group_identifiers[14][8].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[14][8].str = checked_strdup("PMOVMSKB");	// Move Byte Mask
	group_identifiers[14][9].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[14][9].str = checked_strdup("STMXCSR");	// store register state
	...
	group_identifiers[14][11].str = checked_strdup("VZEROUPPER");	// Zero Upper Bits of YMM Registers
	group_identifiers[14][12].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[14][12].str = checked_strdup("UNPCKLPS");		// fp
	group_identifiers[14][13].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[14][13].str = checked_strdup("PSHUFB");
	group_identifiers[14][14].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[14][14].str = checked_strdup("UNPCKLPD");
	group_identifiers[14][15].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[14][15].str = checked_strdup("VSTMXCSR");
	group_identifiers[14][16].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[14][16].str = checked_strdup("POPCNT");
	group_identifiers[14][17].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[14][17].str = checked_strdup("VPMOVMSKB");
	group_identifiers[14][18].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[14][18].str = checked_strdup("VLDMXCSR");
	...
	group_identifiers[15][6].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[15][6].str = checked_strdup("PSLLDQ");	// double Qword
	...
	group_identifiers[16][0].str = checked_strdup("VINSERTF128");	// f
	group_identifiers[16][1].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[16][1].str = checked_strdup("VINSERTPS");		// f
	group_identifiers[16][2].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[16][2].str = checked_strdup("VPINSRD");		// Dword
	group_identifiers[16][3].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[16][3].str = checked_strdup("VINSERTI128");	// i
	group_identifiers[16][4].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[16][4].str = checked_strdup("VPINSRQ");		// Qword
	...
	group_identifiers[17][0].str = checked_strdup("VEXTRACTF128");	// f
	group_identifiers[17][1].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[17][1].str = checked_strdup("VEXTRACTI128");	// i
	group_identifiers[17][2].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[17][2].str = checked_strdup("VPEXTRW");		// word
	group_identifiers[17][3].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[17][3].str = checked_strdup("PEXTRD");		// Dword
	...
	group_identifiers[18][0].str = checked_strdup("VPERM2I128");	// Integer
	...
	group_identifiers[19][0].str = checked_strdup("PALIGNR");
	group_identifiers[19][1].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[19][1].str = checked_strdup("VPALIGNR");
	...
	group_identifiers[20][0].str = checked_strdup("VPBLENDVB"); // Packed Bytes
	group_identifiers[20][1].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[20][1].str = checked_strdup("VBLENDVPD"); // Packed Double Precision Floating-Point
	group_identifiers[20][2].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[20][2].str = checked_strdup("VBLENDVPS"); // Packed Single Precision Floating-Point
    ...
    group_identifiers[21][0].str = checked_strdup("MULSD");     // Scalar Double Precision
    group_identifiers[21][1].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][1].str = checked_strdup("DIVSD");
    group_identifiers[21][2].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][2].str = checked_strdup("ADDSD");
    group_identifiers[21][3].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][3].str = checked_strdup("SUBSD");
    group_identifiers[21][4].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][4].str = checked_strdup("MULSS");
    group_identifiers[21][5].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][5].str = checked_strdup("DIVSS");
    group_identifiers[21][6].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][6].str = checked_strdup("ADDSS");
    group_identifiers[21][7].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][7].str = checked_strdup("SUBSS");
    group_identifiers[21][8].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][8].str = checked_strdup("VMULSD");
    group_identifiers[21][9].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][9].str = checked_strdup("VDIVSD");
    group_identifiers[21][10].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][10].str = checked_strdup("VADDSD");
    group_identifiers[21][11].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][11].str = checked_strdup("VSUBSD");
    group_identifiers[21][12].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][12].str = checked_strdup("VMULPD");
    group_identifiers[21][13].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][13].str = checked_strdup("VDIVPD");
    group_identifiers[21][14].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][14].str = checked_strdup("VADDPD");
    group_identifiers[21][15].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][15].str = checked_strdup("VSUBPD");
    group_identifiers[21][16].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][16].str = checked_strdup("VMULPS");
    group_identifiers[21][17].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][17].str = checked_strdup("VDIVPS");
    group_identifiers[21][18].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][18].str = checked_strdup("VADDPS");
    group_identifiers[21][19].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][19].str = checked_strdup("VSUBPS");
    group_identifiers[21][20].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][20].str = checked_strdup("VMULSS");
    group_identifiers[21][21].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][21].str = checked_strdup("VDIVSS");
    group_identifiers[21][22].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][22].str = checked_strdup("VADDSS");
    group_identifiers[21][23].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][23].str = checked_strdup("VSUBSS");
    group_identifiers[21][24].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][24].str = checked_strdup("SHUFPS");   //  Packed Integers
    group_identifiers[21][25].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][25].str = checked_strdup("VSHUFPS");
    group_identifiers[21][26].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][26].str = checked_strdup("UNPCKLPS"); // unsigned doubleword
    group_identifiers[21][27].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][27].str = checked_strdup("UNPCKLPD"); // packed bytes
    group_identifiers[21][28].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][28].str = checked_strdup("UCOMISD");
    group_identifiers[21][29].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][29].str = checked_strdup("VUCOMISD");
    group_identifiers[21][30].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][30].str = checked_strdup("UCOMISS");
    group_identifiers[21][31].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][31].str = checked_strdup("VINSERTF128");  // string byte or word data
    group_identifiers[21][32].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][32].str = checked_strdup("VINSERTPS");        // greater than Dword
    group_identifiers[21][33].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][33].str = checked_strdup("COMISS");
    group_identifiers[21][34].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][34].str = checked_strdup("VEXTRACTF128");
    group_identifiers[21][35].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][35].str = checked_strdup("VBLENDVPD");        // signed word
    group_identifiers[21][36].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][36].str = checked_strdup("VBLENDVPS");
    group_identifiers[21][37].type = identifier_type::ID_TYPE_OPCODE;
    group_identifiers[21][37].str = checked_strdup("COMISD");
...
VOID instrument_itypes(INS ins, VOID* v, bool is_ROI){
	...
	if( strcmp(checked_strdup("AVX"), cat) == 0 || strcmp(checked_strdup("AVX2"), cat) == 0 || strcmp(checked_strdup("SSE"), cat) == 0 || strcmp(checked_strdup("MMX"), cat) == 0) if (!opcoded) {
		// check whether this category is already known in the 'other' group
		// std::cout << INS_Disassemble(ins) << std::endl;
		for(i=0; i < other_ids_cnt; i++){
			if(strcmp(other_group_identifiers[i].str, opcode) == 0)
