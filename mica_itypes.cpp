...
VOID init_itypes_default_groups(){
	...
	group_identifiers[13][24].str = checked_strdup("SHUFPS");	//	Packed Integers
	group_identifiers[13][25].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[13][25].str = checked_strdup("VSHUFPS");
	group_identifiers[13][26].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[13][26].str = checked_strdup("UNPCKLPS");	// unsigned doubleword
	group_identifiers[13][27].type = identifier_type::ID_TYPE_OPCODE;
	group_identifiers[13][27].str = checked_strdup("UNPCKLPD");	// packed bytes
	...
	// group_identifiers[14][6].str = checked_strdup("");	// fp
	// group_identifiers[14][7].type = identifier_type::ID_TYPE_OPCODE;
	// group_identifiers[14][7].str = checked_strdup("");	// fp
	...
	// group_identifiers[14][12].str = checked_strdup("");		// fp
	...
	// group_identifiers[14][14].str = checked_strdup("");
	...
	// group_identifiers[16][0].str = checked_strdup("");	// f
	// group_identifiers[16][1].type = identifier_type::ID_TYPE_OPCODE;
	// group_identifiers[16][1].str = checked_strdup("");		// f
	...
	// group_identifiers[17][0].str = checked_strdup("");	// f
	...
	// group_identifiers[20][1].str = checked_strdup(""); // Packed Double Precision Floating-Point
	// group_identifiers[20][2].type = identifier_type::ID_TYPE_OPCODE;
	// group_identifiers[20][2].str = checked_strdup(""); // Packed Single Precision Floating-Point
